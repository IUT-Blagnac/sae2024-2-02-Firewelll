...
| 1    | https://github.com/IUT-Blagnac/sae2024-2-02-Firewelll/blob/main/src/main/java/iut/sae/algo/Algo.java[meilleur java]| Java     | Simplicité
| 2    | https://github.com/IUT-Blagnac/sae2024-2-02-Firewelll/blob/main/src/main/java/iut/sae/algo/Algo.java[meilleur java]| Java     | Efficacité
| 3    | https://github.com/IUT-Blagnac/sae2024-2-02-Firewelll/blob/main/src/main/java/iut/sae/algo/Algo.java[meilleur java]| Java     | Sobriété
|==========================================================================

_C'est les mêmes liens._
...
. Télécharger les fichiers AlgoTest.java, test.c, unity_internals.h, unity.c, unity.h et algo.h
* Java
. Placer AlgoTest.java dans src\test\java\iut\sae\algo\
* C
. test.c, unity_internals.h, unity.c, unity.h et algo.h doivent être dans le même répertoire que le programme à tester.
. algo.h doit contenir les bonnes signatures, les modifiers si besoin.

=== Références

- https://app.codacy.com/organizations/[Codacy]
- https://findbugs.sourceforge.net/[FindBugs]
